...
class MatmulCtpt : public Module {
    public:
        ...
        MatmulCtpt(uint64_t dim_0, const Tensor<uint64_t>& weight, const Tensor<uint64_t>& bias, HE::HEEvaluator* HE);
        MatmulCtpt(uint64_t dim_0, uint64_t dim_1, uint64_t dim_2, HE::HEEvaluator* HE);
    
        virtual ~MatmulCtpt() = default;
...
class MatmulCtptBolt : public MatmulCtpt {
    public:
        ...
        MatmulCtptBolt(uint64_t dim_0, const Tensor<uint64_t>& weight, const Tensor<uint64_t>& bias, HE::HEEvaluator* HE);
        MatmulCtptBolt(uint64_t dim_0, uint64_t dim_1, uint64_t dim_2, HE::HEEvaluator* HE);
