...
class Conv2D : public Module{
    public:
        ...
        Tensor<int> kernel;
        HEEvaluator* he;
        Conv2D(int in_channels, int out_channels, int kernel_size, int stride, int padding, HEEvaluator* he, Tensor<int> inputTensor, Tensor<int> kernel);
        virtual Tensor<Plaintext> PackWeight(Tensor<int> x);
