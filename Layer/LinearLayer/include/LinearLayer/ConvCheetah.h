...
//     }
    ...
    // Conv2DCheetah (size_t H, size_t W, HEEvaluator* he, Tensor<int> kernel){
    //     this->he = he;
    //     C = out_channels;
    //     M = in_channels;
    //     s = stride;
...
// // class ConvCheetah : public LinearLayer::Conv2D {
// // public:
...
// //     ConvCheetah(int in_channels, int out_channels, int kernel_size, int stride, int padding, HEEvaluator* he, Tensor<int> inputTensor, Tensor<int> kernel);

// //     Tensor<seal::Ciphertext> EncryptTensor(Tensor<seal::Plaintext> plainTensor);
// //     Tensor<seal::Plaintext> PackTensor(Tensor<int> x);
// //     Tensor<seal::Plaintext> PackKernel(Tensor<int> x);
// //     Tensor<seal::Ciphertext> Conv(Tensor<seal::Ciphertext> T, Tensor<seal::Plaintext> K);

// // private:
// //     int div_upper(int a, int b);
// //     int calculate_cost(int H, int W, int h, int Hw, int Ww, int C, int N);
// //     void find_optimal_partition(int H, int W, int h, int C, int N, int* optimal_Hw, int* optimal_Ww);
// // };
